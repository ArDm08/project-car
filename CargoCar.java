...
final class CargoCar  {
		...
		public CargoCar(String name, int yearOfProduktion, int waight, String color, String engineTipe, double volumeEngine,
		...
		public String toString() {
			return "CargoCar [name=" + name + ", yearOfProduktion=" + yearOfProduktion + ", waight=" + waight + ", color="
