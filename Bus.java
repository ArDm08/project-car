...
final class Bus  {
		...
		public Bus(String name, int yearOfProduktion, int waight, String color, String engineTipe, double volumeEngine,
		...
		public String toString() {
			return "Bus [name=" + name + ", yearOfProduktion=" + yearOfProduktion + ", waight=" + waight + ", color="
